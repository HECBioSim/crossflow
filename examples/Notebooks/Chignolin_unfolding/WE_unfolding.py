...
pmemd = SubprocessKernel('pmemd.cuda -i mdin -c x.inpcrd -p x.prmtop -r x.ncrst -o x.log')
...
for c in range(n_cycles):
    ...
    logging.info('per-walker minimum non-zero probability: {:8.6f}'.format(walker_wt_min))
